...
"""Abstract base class representing assignment duck type"""
...
class Grader:
    ...
    """Check if assignment_class conforms to the Assignment duck type
    and add to assignment_classes dictionary if so"""
